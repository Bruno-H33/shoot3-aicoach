  ...
  return (
    <div className="mobile-container flex flex-col items-center justify-center bg-background px-6">
      ...
      <div className="mb-6 text-center">
        ...
        <h1 className="font-sport text-5xl text-foreground mb-2">
          BRAVO, {userName.toUpperCase()} !
        </h1>
        <p className="font-body text-sm text-muted-foreground leading-relaxed">
          Ton analyse IA est prête. Crée ton compte pour sauvegarder tes résultats et débloquer ton rapport complet.
        </p>
      </div>
      ...
      <div className="w-full space-y-3 mt-4">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 rounded-2xl py-4 px-6 bg-foreground text-background font-body font-semibold text-sm transition-all active:scale-95"
        >
